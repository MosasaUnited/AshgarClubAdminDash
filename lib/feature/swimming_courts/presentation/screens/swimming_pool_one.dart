...
class SwimmingPoolOne extends StatefulWidget {
  const SwimmingPoolOne({super.key});

  @override
  State<SwimmingPoolOne> createState() => _SwimmingPoolOneState();
}

class _SwimmingPoolOneState extends State<SwimmingPoolOne> {

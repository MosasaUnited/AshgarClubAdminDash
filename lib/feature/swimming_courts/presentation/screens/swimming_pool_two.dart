...
class SwimmingPoolTwo extends StatefulWidget {
  const SwimmingPoolTwo({super.key});

  @override
  State<SwimmingPoolTwo> createState() => _SwimmingPoolTwoState();
}

class _SwimmingPoolTwoState extends State<SwimmingPoolTwo> {

...
class SwimmingPoolThree extends StatefulWidget {
  const SwimmingPoolThree({super.key});

  @override
  State<SwimmingPoolThree> createState() => _SwimmingPoolTwoState();
}

class _SwimmingPoolTwoState extends State<SwimmingPoolThree> {
  DateTime _selectedDay = DateTime.utc(2024, 9, 20);
              ...
              child: Column(
                ...
                children: [
                  ...
                  TableCalendar(
                    ...
                    firstDay: DateTime.utc(2024, 9, 19),
